...
export const EAHEDCalculatorSection = () => {
    return (
                        ...
                        <div className="w-full mx-auto bg-[#1C2743]/40 rounded-xl p-8 flex flex-col gap-8">
                            <div className="w-full rounded-xl">
                                ...
                                <h2 className="text-content text-gray-300 text-sm my-4 text-center">
                                    Enhance HVAC efficiency with our
                                    user-friendly tool. Accurately size systems,
                                    save energy, and streamline the design
                                    process for optimal comfort in any space.
                                    Elevate your HVAC strategy with precision
                                    and simplicity.
                                </h2>
                            </div>
                        </div>
